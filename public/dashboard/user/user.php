...
nav{background:#fff;padding:15px 30px;display:flex;justify-content:space-between;align-items:center;box-shadow:0 2px 8px rgba(0,0,0,0.08);position:sticky;top:0;z-index:999;}
nav a{text-decoration:none;color:#333;margin-right:15px;font-weight:bold;}
nav a:hover{color:#007bff;}
.profile{display:flex;align-items:center;gap:20px;background:white;padding:25px;margin:20px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.08);}
.profile img{width:100px;height:100px;border-radius:50%;object-fit:cover;}
.cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:20px;margin:20px;}
.card{padding:25px;border-radius:12px;color:white;box-shadow:0 2px 8px rgba(0,0,0,0.08);}
.card h2{font-size:32px;margin-bottom:10px;}
.blue{background:#007bff;}
.red{background:#dc3545;}
.orange{background:#fd7e14;}
.green{background:#198754;}
.box{background:white;padding:20px;margin:20px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.08);}
input,textarea,select{width:100%;padding:10px;margin-top:10px;border:1px solid #ccc;border-radius:8px;}
button{padding:10px 15px;border:none;border-radius:8px;background:#007bff;color:white;cursor:pointer;margin-top:10px;}
button:hover{opacity:0.9;}
.notif-wrapper{position:relative;}
#notifPanel{display:none;position:absolute;right:0;top:45px;width:350px;max-height:400px;overflow-y:auto;background:white;border-radius:12px;box-shadow:0 4px 15px rgba(0,0,0,0.15);z-index:999;}
.notif-item{padding:15px;border-bottom:1px solid #eee;cursor:pointer;}
.notif-item.unread{background:#eef5ff;}
#notifCount{position:absolute;top:-5px;right:-5px;background:red;color:white;border-radius:50%;font-size:12px;padding:2px 7px;display:none;}
...
<!-- DASHBOARD -->
<div class="cards">
    <div class="card blue"><h2 id="totalReports">0</h2><p>📍 My Reports</p></div>
    <div class="card red"><h2 id="activeOutages">0</h2><p>⚡ Active Outages</p></div>
    <div class="card orange"><h2 id="maintenanceCount">0</h2><p>🛠 Upcoming Maintenance</p></div>
    <div class="card green"><h2 id="notifTotal">0</h2><p>🔔 Notifications</p></div>
</div>
...
<div class="box">
    ...
    <form action="<?= BASE_URL ?>/src/api/user/update_profile.php"
          method="POST"
